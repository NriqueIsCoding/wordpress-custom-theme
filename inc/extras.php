		...
		<nav class="container navigation post-navigation">
			...
			<div class="row nav-links justify-content-between">
				...
				if ( get_previous_post_link() ) {
					previous_post_link( '<button class="btn btn-lg post-navigation-button">%link</button>', _x( '<i class="fa fa-angle-left"></i>&nbsp;%title', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<button class="btn btn-lg  post-navigation-button">%link</button>', _x( '%title&nbsp;<i class="fa fa-angle-right"></i>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
